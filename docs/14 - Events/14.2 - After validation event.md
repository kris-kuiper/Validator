...
Go to the [previous section](/docs/14%20-%20Events/14.1%20-%20Before%20validation%20event.md).

Go to the [next section](/docs/15%20-%20Storage/15.1%20-%20Validation%20storage.md).